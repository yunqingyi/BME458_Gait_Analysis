...
class Win(QWidget):
    def __init__(self):
        ...
        self.Label_Strd_time_heel_L.setText("Average Stride Time(Left):")
        ...
        self.Label_Strd_time_heel_R.setText("Average Stride Time(Right):")
        self.Label_Strd_time_heel_R.resize(600, 100)
        self.Label_Strd_time_heel_R.move(1100, 150)
    ...
    def pressure_analysis(self):
        ...
        # nominal case
        if num_L_changepoints_13 > 1 and num_R_changepoints_21 > 1:
        ...
        elif num_L_changepoints_13 < (num_L_changepoints_21 - 3):
            error_code_L = -2
        # missing toe off
        elif num_L_changepoints_21 == 0:
            error_code_L = -3
        # insufficient toe engagement
        elif num_L_changepoints_21 < (num_L_changepoints_13 - 3):
            error_code_L = -4
        else:
            error_code_L = 0

        # nominal case
        if num_R_changepoints_13 > 1 and num_L_changepoints_21 > 1:
            # stride time based on heel strike
        ...
        if num_R_changepoints_13 == 0:
            error_code_R = -1
        # insufficient heel engagement
        elif num_R_changepoints_13 < (num_R_changepoints_21 - 3):
            error_code_R = -2
        # missing toe off
        elif num_R_changepoints_21 == 0:
            error_code_R = -3
        # insufficient toe engagement
        elif num_R_changepoints_21 < (num_R_changepoints_13 - 3):
            error_code_R = -4
        else:
            error_code_R = 0

        # not enough data collected
        if num_L_changepoints_13 <= 2 and num_R_changepoints_13 <= 2:
        ...
        print("stride times")
        print(L_stride_time_heel)
        print(R_stride_time_heel)
        print(L_stride_time_toe)
        print(R_stride_time_toe)
        ...
        if L_stride_time_avg_heel > 1:
            self.Label_Strd_time_heel_L.setText("Average Stride Time(Left, in ms): " + str(L_stride_time_avg_heel))
        else:
            self.Label_Strd_time_heel_L.setText("Average Stride Time(Left): data collection error")
        if R_stride_time_avg_heel > 1:
            self.Label_Strd_time_heel_R.setText("Average Stride Time(Right, in ms): " + str(R_stride_time_avg_heel))
        else:
            self.Label_Strd_time_heel_R.setText("Average Stride Time(Right): data collection error")
        # TODO display avg stride time based on heel strike
        if L_stride_time_avg_toe > 1:
            self.Label_Strd_time_toe_L.setText("Average Stride Time(Left, in ms): " + str(L_stride_time_avg_heel))
        else:
            self.Label_Strd_time_toe_L.setText("Average Stride Time(Left): data collection error")
        if R_stride_time_avg_toe > 1:
            self.Label_Strd_time_toe_R.setText("Average Stride Time(Right, in ms): " + str(R_stride_time_avg_heel))
        else:
            self.Label_Strd_time_toe_R.setText("Average Stride Time(Right): data collection error")
